...
**	point. Therefore a floating point sample can be converted to a 16 bit
**	short by multiplying by 32767.0 and casting to short.
**
...
**
**	The host currently supports 4 audio channels types: mono, stereo, 5.1 and 16 channel.
**	Stereo channel ordering is left, right.
**	5.1 channels ordering is left, right, left surround, right surround, center, lfe.
**	16 channel ordering is undetermined, 0-15 channels are provided.
*/
