...
#define RENDERMOD_VERSION	prAcceleratedRendererVersion600
...
typedef enum
{
	arRenderIntent_Unknown = -1,
	arRenderIntent_Export = 0,
	arRenderIntent_Stopped,
	arRenderIntent_Scrubbing,
	arRenderIntent_Preroll,
	arRenderIntent_Playing,
	arRenderIntent_SpeculativePrefetch,
} arRenderIntent;
typedef struct 
{
	arRenderIntent inIntent;
...
#define arPlaybackRatio_Normal 1.0
#define arPlaybackRate_Stopped 0.0
inline arRenderContext arDefaultRenderContext() { arRenderContext context = {arRenderIntent_Unknown,arPlaybackRatio_Normal,arPlaybackRate_Stopped}; return context; }
...
typedef struct
{
	...
	bool inRenderFields;
	arRenderContext mRenderContext;
} arRenderRequest;
